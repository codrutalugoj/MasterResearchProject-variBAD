...
def get_args(rest_args):
    ...
    parser.add_argument('--max_rollouts_per_task', type=int, default=4, help='number of MDP episodes for adaptation') # default: 4
    ...
    parser.add_argument('--kl_weight', type=float, default=0.01, help='weight for the KL term') # default: 0.01
