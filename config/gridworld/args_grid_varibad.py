...
def get_args(rest_args):
    ...
    parser.add_argument('--probRewardPerc', type=float, default=0.0,
                        help='probability of the VAE perceiving a random reward')
    ...
    # TODO: lr_policy was 0.0007 0.01
    ...
    parser.add_argument('--kl_weight', type=float, default=0.01, help='weight for the KL term')  # TODO: was 0.01
    ...
    parser.add_argument('--encoder_gru_hidden_size', type=int, default=20, help='dimensionality of RNN hidden state')
    ...
    parser.add_argument('--log_interval', type=int, default=100, help='log interval, one log per n updates')
    ...
    parser.add_argument('--eval_interval', type=int, default=100, help='eval interval, one eval per n updates')
